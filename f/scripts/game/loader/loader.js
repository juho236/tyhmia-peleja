...
import { Color3, Colors, Sizes, UILayer } from "../../classes/ui/index.js";
...
export const LoadLoader = () => {
    ...
    const bg = new UIFrame(undefined,Sizes.Fullscreen,undefined,new Color3(255,0,0,0));
